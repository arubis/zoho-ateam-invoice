...
64 tests covering date parsing, CSV hour formats, PDF regex parsing, exact-match idempotency, discrepancy detection, the invoice-total guard, env credential loading (precedence and merging), API payload shape, org ID propagation, payment routing, filename period-pairing, and batch behavior.
